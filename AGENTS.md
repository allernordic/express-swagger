...
- `scripts/` — `build-types.js` (dts-buddy bundle), run by `npm run build`. The README table of contents is regenerated by `@0dep/toc` (`npm run toc`, also part of the build).
